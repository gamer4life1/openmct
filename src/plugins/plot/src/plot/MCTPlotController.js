...
define(["./LinearScale", "../lib/eventHelpers"], function (
  LinearScale,
  eventHelpers
) {
  /**
  ...
  MCTPlotController.prototype.initialize = function () {
    ...
    this.cursorGuideVertical = this.$element[0].querySelector(
      ".js-cursor-guide--v"
    );
    this.cursorGuideHorizontal = this.$element[0].querySelector(
      ".js-cursor-guide--h"
    );
    ...
    this.listenTo(
      this.$scope,
      "plot:highlight:set",
      this.onPlotHighlightSet,
      this
    );
    this.listenTo(
      this.$scope,
      "plot:reinitializeCanvas",
      this.initCanvas,
      this
    );
    this.listenTo(
  ...
  MCTPlotController.prototype.trackMousePosition = function ($event) {
    ...
    this.positionOverElement = {
      ...
      y:
        this.chartElementBounds.height -
  ...
  MCTPlotController.prototype.toggleYAxisLabel = function (
    label,
    options,
    series
  ) {
