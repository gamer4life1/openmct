...
export default class ConditionClass extends EventEmitter {
   ...
   * criteria evaluated.
   * @constructor
   * @param conditionConfiguration: {id: uuid,trigger: enum, criteria: Array
   *     of {id: uuid, operation: enum, input: Array, metaDataKey: string,
   *     key: {domainObject.identifier} }
   * @param openmct
   */
  ...
  destroyCriteria() {
    let success = true;
    // looping through the array backwards since destroyCriterion modifies the
    // criteria array
