...
describe('the plugin', function() {
  beforeAll((done) => {
    ...
    mockConditionSetDomainObject = {
      identifier : {key : 'testConditionSetKey', namespace : ''},
      type : 'conditionSet'
    };
  ...
  describe('the conditionSet object', () => {
    it('is creatable', () => {
      expect(conditionSetDefinition.creatable)
          .toEqual(mockConditionSetObject.creatable);
    });

    it('initializes with an empty composition list', () => {
      expect(mockConditionSetDomainObject.composition instanceof Array)
          .toBeTrue();
    ...
    it('provides a view', () => {
      ...
      let conditionSetView = applicableViews.find(
