...
describe('ConditionSetCompositionPolicy', () => {
  ...
  beforeAll(function() {
    ...
    openmct.telemetry =
        jasmine.createSpyObj('telemetry', [ 'isTelemetryObject' ]);
  ...
  it('returns false for object types that are not telemetry objects when parent is a conditionSet',
     function() {
  ...
  it('returns true for object types that are telemetry objects when parent is a conditionSet',
     function() {
       parentDomainObject.type = 'conditionSet';
  ...
  it('returns true for object types that are telemetry objects when parent is not a conditionSet',
     function() {
       parentDomainObject.type = 'random';
       openmct.telemetry.isTelemetryObject.and.returnValue(true);
       expect(policy.allow(parentDomainObject, testTelemetryObject)).toBe(true);
