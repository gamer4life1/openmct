...
describe("evaluate results", () => {
  ...
  // const oneTrueWithUndefined = [undefined, undefined, undefined, undefined,
  // true]; const multipleTrueWithUndefined = [true, undefined, true, undefined,
  // true]; const allUndefined = [undefined, undefined, undefined, undefined,
  // undefined]; const singleTrue = [true]; const singleFalse = [false]; const
  // singleUndefined = [undefined]; const empty = [];
