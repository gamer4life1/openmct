...
import NotebookSnapshotIndicator from
    './components/notebook-snapshot-indicator.vue';
...
export default function NotebookPlugin() {
  return function install(openmct) {
    ...
    const notebookSnapshotIndicator = new Vue({
      provide : {openmct, snapshotContainer},
      components : {NotebookSnapshotIndicator},
      template : '<NotebookSnapshotIndicator></NotebookSnapshotIndicator>'
    });
    const indicator = {element : notebookSnapshotIndicator.$mount().$el};
    ...
    openmct.objectViews.addProvider({
      ...
      cssClass : 'icon-notebook',
      canView : function(
          domainObject) { return domainObject.type === 'notebook'; },
        ...
        return {
          show(container) {
            component = new Vue({
              el : container,
              components : {Notebook},
              provide : {openmct, domainObject, snapshotContainer},
