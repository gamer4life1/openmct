          ...
          if (selection.length === 1) {
            ...
            return {
              ...
              method: function (option) {
                ...
                if (form) {
                  getUserInput(form).then((element) =>
                    selectionPath[0].context.addElement(name, element)
                  );
                } else {
        ...
        function getDisplayModeMenu(selectedParent, selection) {
          if (selection.length === 1) {
            return {
              ...
              applicableSelectedItems: selection.filter((selectionPath) => {
                return (
                  selectionPath[0].context.layoutItem.type === "telemetry-view"
                );
              }),
              property: function (selectionPath) {
        ...
        selectedObjects.forEach((selectionPath) => {
          ...
          if (layoutItem.type === "subobject-view") {
            ...
            if (toolbar.remove.length === 0) {
              toolbar.remove = [
                getRemoveButton(selectedParent, selectionPath, selectedObjects),
              ];
            }
